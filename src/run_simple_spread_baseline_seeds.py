from train_simple_spread_baseline import train_simple_spread_baseline
...
def main():
    ...
    for seed in seeds:
        print("\n" + "=" * 70)
        print(f"Starting Simple Spread baseline run for seed = {seed}")
        print("=" * 70)

        summary = train_simple_spread_baseline(
            seed=seed,
    ...
    print("\n" + "=" * 70)
    print("All Simple Spread baseline runs finished.")
    print("=" * 70)
